    ...
    <a-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <a-form-item prop="username">
        <a-input v-model="loginForm.username" type="text" auto-complete="off" placeholder="账号">
          <svg-icon slot="prefix" icon-class="user" class="a-input__icon input-icon" />
        </a-input>
      </a-form-item>
      <a-form-item prop="password">
        ...
        >
          <svg-icon slot="prefix" icon-class="password" class="a-input__icon input-icon" />
        </a-input>
      </a-form-item>
      <a-form-item prop="code">
        <a-input
          ...
          @keyup.enter.native="handleLogin"
        >
          <svg-icon slot="prefix" icon-class="validCode" class="a-input__icon input-icon" />
        </a-input>
